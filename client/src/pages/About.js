    ...
    render() {
        return (
            <div>
                ...
                <div className="col-md-9"><strong>Christine Baine</strong> Lemon drops sugar plum jelly carrot cake sweet roll tootsie roll macaroon dragée. Toffee tart bear claw gingerbread lemon drops. Icing apple pie marshmallow jelly gummi bears. Gummies halvah brownie gingerbread. Cotton candy caramels apple pie marzipan pie jelly beans. Gummies powder oat cake apple pie tart. Jujubes sesame snaps brownie chocolate bar. Cheesecake gummies icing tiramisu carrot cake apple pie cotton candy tart. Sugar plum soufflé chupa chups. Dragée apple pie tiramisu cupcake chocolate bar.</div>
